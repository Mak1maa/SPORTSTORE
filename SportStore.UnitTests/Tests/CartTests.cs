...
namespace SportStore.UnitTests
{
    ...
    public class CartTests
    {
        ...
        public void Can_Add_New_Lines()
        {
            ...
            Products products1 = new Products { ProductsID = 1, Name = "Вещь1" };
            Products products2 = new Products { ProductsID = 2, Name = "Вещь2" };

            // Организация - создание корзины
            Cart cart = new Cart();

            // Действие
            cart.AddItem(products1, 1);
            cart.AddItem(products2, 1);
            List<CartLine> results = cart.Lines.ToList();

            // Утверждение
            Assert.AreEqual(results.Count(), 2);
            Assert.AreEqual(results[0].Products, products1);
            Assert.AreEqual(results[1].Products, products2);
        }
        ...
        public void Can_Add_Quantity_For_Existing_Lines()
        {
            ...
            cart.AddItem(products1, 1);
            cart.AddItem(products2, 1);
            cart.AddItem(products1, 5);
            List<CartLine> results = cart.Lines.OrderBy(c => c.Products.ProductsID).ToList();
        ...
        public void Can_Remove_Line()
        {
            ...
            Products products1 = new Products { ProductsID = 1, Name = "Вещь1" };
            Products products2 = new Products { ProductsID = 2, Name = "Вещь2" };
            Products products3 = new Products { ProductsID = 3, Name = "Вещь3" };
            ...
            cart.AddItem(products1, 1);
            cart.AddItem(products2, 4);
            cart.AddItem(products3, 2);
            cart.AddItem(products2, 1);

            // Действие
            cart.RemoveLine(products2);

            // Утверждение
            Assert.AreEqual(cart.Lines.Where(c => c.Products == products2).Count(), 0);
        ...
        {
            // Организация - создание нескольких тестовых игр
            Products products1 = new Products { ProductsID = 1, Name = "Вещь1", Price = 100 };
            Products products2 = new Products { ProductsID = 2, Name = "Вещь2", Price = 55 };
        ...
        public void Can_Add_To_Cart()
        {
            ...
            mock.Setup(m => m.Products).Returns(new List<Products> {
                new Products {ProductsID = 1, Name = "Вещь1", Category = "Кат1"},
            }.AsQueryable());
            ...
            Assert.AreEqual(cart.Lines.ToList()[0].Products.ProductsID, 1);
        }
