...
namespace WindowsFormsApp2 {
    ...
    public partial class StoreDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string Name, string Description, int Quantity, decimal Price) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow FindByProductsID(int ProductsID) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public int ProductsID {
                get {
                    return ((int)(this[this.tableProducts.ProductsIDColumn]));
                }
                set {
                    this[this.tableProducts.ProductsIDColumn] = value;
                }
            }
...
namespace WindowsFormsApp2.StoreDBDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductsID] = @Original_ProductsID) AND ([N" +
                "ame] = @Original_Name) AND ([Description] = @Original_Description) AND ([Quantit" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Name], [Description], [Quantity], [Price]) VALUES " +
                "(@Name, @Description, @Quantity, @Price);\r\nSELECT ProductsID, Name, Description," +
                " Quantity, Price FROM Products WHERE (ProductsID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [Description] = @Description, [Quantity] = @Quantity, [Price] = @Price WHERE (([ProductsID] = @Original_ProductsID) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price));
SELECT ProductsID, Name, Description, Quantity, Price FROM Products WHERE (ProductsID = @ProductsID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp2.Properties.Settings.Default.StoreDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductsID, Name, Description, Quantity, Price FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ProductsID, string Original_Name, string Original_Description, int Original_Quantity, decimal Original_Price) {
        ...
        public virtual int Insert(string Name, string Description, int Quantity, decimal Price) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Description, int Quantity, decimal Price, int Original_ProductsID, string Original_Name, string Original_Description, int Original_Quantity, decimal Original_Price, int ProductsID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(ProductsID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, int Quantity, decimal Price, int Original_ProductsID, string Original_Name, string Original_Description, int Original_Quantity, decimal Original_Price) {
            return this.Update(Name, Description, Quantity, Price, Original_ProductsID, Original_Name, Original_Description, Original_Quantity, Original_Price, Original_ProductsID);
        }
    }
